...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n pll1 -lang verilog -synth lse -arch xo2c00 -type pll -fin 50 -mdiv 3 -ndiv 1 -trimp 0 -phasep 0 -trimp_r -adiv 16 -phase_cntl STATIC -fb_mode 1  */
/* Wed Aug 23 18:07:55 2023 */


`timescale 1 ns / 1 ps
module pll1 (CLKI, CLKOP)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOP="16.666667" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 16.666667
